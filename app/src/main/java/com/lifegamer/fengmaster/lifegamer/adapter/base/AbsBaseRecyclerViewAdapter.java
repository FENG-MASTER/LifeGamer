...
public abstract class AbsBaseRecyclerViewAdapter<T extends RecyclerView.ViewHolder,R> extends RecyclerView.Adapter<T> implements IName,ItemSelectObservable<R> {
